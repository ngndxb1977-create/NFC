...
def get_clean_model_name(raw_name):
    ...
    elif 'DESTINATOR' in raw_name_upper:
        return 'Destinator'
    return raw_name
...
if not VEHICLE_CATALOG["2025"] and not VEHICLE_CATALOG["2026"]:
    ...
    calculated_downpayment = st.session_state.base_vehicle_price * st.session_state.get("down_payment_pct", 0.20)
    finance_amount = max(0.0, full_vehicle_value_including_addons - calculated_downpayment)
